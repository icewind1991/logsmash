...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/composer/composer/ClassLoader.php" , line : 256usize , placeholders : & [] , regex : "^A non\\-empty PSR\\-4 prefix must end with a namespace separator\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/composer/composer/ClassLoader.php" , line : 311usize , placeholders : & [] , regex : "^A non\\-empty PSR\\-4 prefix must end with a namespace separator\\.$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/public/AppFramework/Db/QBMapper.php" , line : 194usize , placeholders : & [] , regex : "^Entity which should be updated has no id$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/public/RichObjectStrings/Definitions.php" , line : 664usize , placeholders : & [] , regex : "^Object type is undefined$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/AppFramework/Http/Request.php" , line : 736usize , placeholders : & ["$requestUri" , "$scriptName"] , regex : "^The requested uri\\((.*)\\) cannot be processed by the script '(.*)'\\)$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/AppFramework/Bootstrap/RegistrationContext.php" , line : 458usize , placeholders : & [] , regex : "^Only the Talk app is allowed to register a Talk backend$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/AppFramework/Bootstrap/RegistrationContext.php" , line : 461usize , placeholders : & [] , regex : "^There can only be one Talk backend$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/AppFramework/Bootstrap/RegistrationContext.php" , line : 506usize , placeholders : & ["$appId"] , regex : "^App (.*) not loaded for the capability registration$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/AppFramework/Bootstrap/RegistrationContext.php" , line : 581usize , placeholders : & ["$appId"] , regex : "^App (.*) not loaded for the container service registration$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/AppFramework/Bootstrap/RegistrationContext.php" , line : 609usize , placeholders : & ["$appId"] , regex : "^App (.*) not loaded for the container alias registration$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/AppFramework/Bootstrap/RegistrationContext.php" , line : 633usize , placeholders : & ["$appId"] , regex : "^App (.*) not loaded for the container parameter registration$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/DB/MigrationService.php" , line : 493usize , placeholders : & [] , regex : "^Not a valid migration$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/DB/MigrationService.php" , line : 499usize , placeholders : & ["$class"] , regex : "^Migration step '(.*)' is unknown$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/DB/Connection.php" , line : 94usize , placeholders : & [] , regex : "^adapter not set$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/DB/Connection.php" , line : 97usize , placeholders : & [] , regex : "^tablePrefix not set$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/DB/Connection.php" , line : 171usize , placeholders : & [] , regex : "^Doctrine QueryBuilder retrieved in \\{backtrace\\}$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/DB/Connection.php" , line : 184usize , placeholders : & [] , regex : "^Doctrine ExpressionBuilder retrieved in \\{backtrace\\}$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/DB/Connection.php" , line : 447usize , placeholders : & [] , regex : "^Can not lock a new table until the previous lock is released\\.$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/DB/QueryBuilder/QueryBuilder.php" , line : 1299usize , placeholders : & [] , regex : "^Invalid call to getLastInsertId without using insert\\(\\) before\\.$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Repair.php" , line : 154usize , placeholders : & ["$repairStep"] , regex : "^Repair step '(.*)' is unknown$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Repair.php" , line : 161usize , placeholders : & ["$repairStep"] , regex : "^Repair step '(.*)' is not of type \\\\OCP\\\\Migration\\\\IRepairStep$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/Dashboard/Manager.php" , line : 118usize , placeholders : & [] , regex : "^Dashboard widget \\{widget\\} took \\{duration\\} seconds to load\\.$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Updater.php" , line : 241usize , placeholders : & [] , regex : "^Updates between multiple major versions and downgrades are unsupported\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/lib/private/Updater.php" , line : 486usize , placeholders : & [] , regex : "^\\\\OC\\\\Updater::maintenanceEnabled: Turned on maintenance mode$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/lib/private/Updater.php" , line : 489usize , placeholders : & [] , regex : "^\\\\OC\\\\Updater::maintenanceDisabled: Turned off maintenance mode$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/lib/private/Updater.php" , line : 492usize , placeholders : & [] , regex : "^\\\\OC\\\\Updater::maintenanceActive: Maintenance mode is kept active$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/lib/private/Updater.php" , line : 496usize , placeholders : & [] , regex : "^\\\\OC\\\\Updater::updateEnd: Update successful$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/Updater.php" , line : 498usize , placeholders : & [] , regex : "^\\\\OC\\\\Updater::updateEnd: Update failed$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/lib/private/Updater.php" , line : 502usize , placeholders : & [] , regex : "^\\\\OC\\\\Updater::dbUpgradeBefore: Updating database schema$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/lib/private/Updater.php" , line : 505usize , placeholders : & [] , regex : "^\\\\OC\\\\Updater::dbUpgrade: Updated database$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/lib/private/Updater.php" , line : 532usize , placeholders : & [] , regex : "^\\\\OC\\\\Updater::setDebugLogLevel: Set log level to debug$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/lib/private/Updater.php" , line : 538usize , placeholders : & [] , regex : "^\\\\OC\\\\Updater::startCheckCodeIntegrity: Starting code integrity check\\.\\.\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/lib/private/Updater.php" , line : 541usize , placeholders : & [] , regex : "^\\\\OC\\\\Updater::finishedCheckCodeIntegrity: Finished code integrity check$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Server.php" , line : 892usize , placeholders : & [] , regex : "^Invalid database type$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Server.php" , line : 1001usize , placeholders : & ["$app"] , regex : "^The app providing the command bus \\((.*)\\) is not enabled$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/lib/private/EventDispatcher/SymfonyAdapter.php" , line : 108usize , placeholders : & [] , regex : "^Deprecated event type for \\{name\\}: \\{class\\}$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Http/Client/Client.php" , line : 188usize , placeholders : & [] , regex : "^Could not detect any host$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Http/Client/Client.php" , line : 191usize , placeholders : & [] , regex : "^Host violates local access rules$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/Security/CertificateManager.php" , line : 99usize , placeholders : & ["$path"] , regex : "^Failed to read certificate from (.*)$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/Security/CertificateManager.php" , line : 102usize , placeholders : & ["$path"] , regex : "^Failed to read certificate from (.*)$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Security/CertificateManager.php" , line : 195usize , placeholders : & [] , regex : "^Filename is not valid$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/Security/CertificateManager.php" , line : 269usize , placeholders : & [] , regex : "^Failed to get absolute bundle path\\. Fallback to default ca\\-bundle\\.crt$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/lib/private/Files/Filesystem.php" , line : 215usize , placeholders : & [] , regex : "^Storage wrapper '\\{wrapper\\}' was not registered via the 'OC_Filesystem \\- preSetup' hook which could cause potential problems\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/ObjectStore/S3ObjectTrait.php" , line : 142usize , placeholders : & [] , regex : "^Error while uploading to S3 bucket$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/ObjectStore/ObjectStoreStorage.php" , line : 77usize , placeholders : & [] , regex : "^missing IObjectStore instance$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/ObjectStore/ObjectStoreStorage.php" , line : 552usize , placeholders : & ["$urn" , "$path"] , regex : "^Object not found after writing \\(urn: (.*), path: (.*)\\)$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/ObjectStore/ObjectStoreStorage.php" , line : 591usize , placeholders : & [] , regex : "^Source object not found$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/ObjectStore/ObjectStoreStorage.php" , line : 622usize , placeholders : & [] , regex : "^Invalid source cache for object store copy$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/ObjectStore/ObjectStoreStorage.php" , line : 640usize , placeholders : & [] , regex : "^Object store does not support multipart upload$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/ObjectStore/ObjectStoreStorage.php" , line : 653usize , placeholders : & [] , regex : "^Object store does not support multipart upload$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/ObjectStore/ObjectStoreStorage.php" , line : 669usize , placeholders : & [] , regex : "^Object store does not support multipart upload$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/ObjectStore/ObjectStoreStorage.php" , line : 692usize , placeholders : & [] , regex : "^Could not write chunked file$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/ObjectStore/S3ConnectionTrait.php" , line : 78usize , placeholders : & [] , regex : "^Bucket has to be configured\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/Files/ObjectStore/S3ConnectionTrait.php" , line : 166usize , placeholders : & [] , regex : "^Invalid remote storage\\.$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/Type/Loader.php" , line : 130usize , placeholders : & ["$mimetype"] , regex : "^Failed to get mimetype id for (.*) after trying to store it$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/Files/SetupManager.php" , line : 445usize , placeholders : & [] , regex : "^mount has no provider set, performing full setup$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/Utils/Scanner.php" , line : 200usize , placeholders : & [] , regex : "^Invalid path to scan$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/Storage/Common.php" , line : 879usize , placeholders : & ["$path"] , regex : "^Failed to open (.*) for writing$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/Storage/Common.php" , line : 884usize , placeholders : & [] , regex : "^Failed to copy stream$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/Storage/Common.php" , line : 897usize , placeholders : & [] , regex : "^Directory listing failed$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/Files/Storage/Wrapper/Encryption.php" , line : 808usize , placeholders : & [] , regex : "^Could not find mount point, can't keep encryption keys$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/Storage/Local.php" , line : 656usize , placeholders : & ["$path"] , regex : "^Failed write stream to (.*)$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/Files/Cache/Scanner.php" , line : 119usize , placeholders : & ["$path"] , regex : "^!!! Path '(.*)' is not accessible or present !!!$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/Cache/Cache.php" , line : 1111usize , placeholders : & [] , regex : "^Invalid source cache entry on copyFromCache$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/View.php" , line : 113usize , placeholders : & [] , regex : "^Root can't be null$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/View.php" , line : 493usize , placeholders : & [] , regex : "^fseek error$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/View.php" , line : 502usize , placeholders : & ["$connectionStatus"] , regex : "^Connection lost\\. Status: (.*)$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/lib/private/Files/View.php" , line : 589usize , placeholders : & [] , regex : "^Error while setting modified time$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/lib/private/Files/View.php" , line : 1022usize , placeholders : & [] , regex : "^Trying to open a file with a mode other than \"r\" or \"w\" can cause severe performance issues with some backends$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/View.php" , line : 1823usize , placeholders : & ["$pathLen" , "$maxLen" , "$path"] , regex : "^Path length\\((.*)\\) exceeds max path length\\((.*)\\): (.*)$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/Files/View.php" , line : 1854usize , placeholders : & [] , regex : "^It is not allowed to move one mount point into a shared folder$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/Files/View.php" , line : 2183usize , placeholders : & [] , regex : "^\\$absolutePath must be relative to \"files\", value is \"\\{absolutePath\\}\"$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Files/View.php" , line : 2189usize , placeholders : & [] , regex : "^\\$absolutePath must be relative to \"files\"$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/SystemTag/SystemTagsInFilesDetector.php" , line : 69usize , placeholders : & [] , regex : "^Could not climb up to root folder$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Avatar/AvatarManager.php" , line : 113usize , placeholders : & [] , regex : "^user does not exist$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/Avatar/AvatarManager.php" , line : 173usize , placeholders : & ["$userId"] , regex : "^No cache for the user (.*)\\. Ignoring avatar deletion$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/Avatar/AvatarManager.php" , line : 175usize , placeholders : & ["$userId"] , regex : "^Unable to delete user avatars for (.*)\\. gnoring avatar deletion$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/Avatar/AvatarManager.php" , line : 177usize , placeholders : & ["$userId"] , regex : "^User (.*) not found\\. gnoring avatar deletion$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/legacy/OC_App.php" , line : 183usize , placeholders : & [] , regex : "^/appinfo/app\\.php is not loaded when \\\\OCP\\\\AppFramework\\\\Bootstrap\\\\IBootstrap on the application class is used\\. Migrate everything from app\\.php to the Application class\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/legacy/OC_App.php" , line : 188usize , placeholders : & [] , regex : "^/appinfo/app\\.php is deprecated, use \\\\OCP\\\\AppFramework\\\\Bootstrap\\\\IBootstrap on the application class instead\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/legacy/OC_App.php" , line : 656usize , placeholders : & [] , regex : "^Failed to detect current app from script path$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/legacy/OC_App.php" , line : 698usize , placeholders : & [] , regex : "^OC_App::registerLogIn\\(\\) is deprecated, please register your alternative login option using the registerAlternativeLogin\\(\\) on the RegistrationContext in your Application class implementing the OCP\\\\Authentication\\\\IAlternativeLogin interface$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/legacy/OC_App.php" , line : 711usize , placeholders : & [] , regex : "^Alternative login option \\{option\\} does not implement \\{interface\\} and is therefore ignored\\.$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/lib/private/legacy/OC_Helper.php" , line : 532usize , placeholders : & [] , regex : "^Error while getting quota info, using root quota$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/lib/private/legacy/OC_Util.php" , line : 771usize , placeholders : & [] , regex : "^Error occurred while checking PostgreSQL version, assuming >= 9$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/legacy/OC_Util.php" , line : 967usize , placeholders : & [] , regex : "^Can't create test file to check for working \\.htaccess file\\.$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Translation/TranslationManager.php" , line : 63usize , placeholders : & [] , regex : "^No translation providers available$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Translation/TranslationManager.php" , line : 72usize , placeholders : & [] , regex : "^Could not detect language$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/lib/private/Translation/TranslationManager.php" , line : 78usize , placeholders : & ["$fromLanguage" , "$toLanguage"] , regex : "^Failed to translate from (.*) to (.*)$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Translation/TranslationManager.php" , line : 82usize , placeholders : & [] , regex : "^Could not translate text$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/Template/JSResourceLocator.php" , line : 100usize , placeholders : & [] , regex : "^Could not find resource \\{resource\\} to load$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/Authentication/Token/PublicKeyTokenProvider.php" , line : 105usize , placeholders : & [] , regex : "^Invalid token provided when generating new token$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Authentication/Token/PublicKeyTokenProvider.php" , line : 155usize , placeholders : & [] , regex : "^Token is too short for a generated token, should be the password during basic auth$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Authentication/Token/PublicKeyTokenProvider.php" , line : 228usize , placeholders : & [] , regex : "^Invalid token type$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Authentication/Token/PublicKeyTokenProvider.php" , line : 280usize , placeholders : & [] , regex : "^Invalid token type$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Authentication/Token/PublicKeyTokenProvider.php" , line : 289usize , placeholders : & [] , regex : "^Invalid token type$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Authentication/Token/PublicKeyTokenProvider.php" , line : 309usize , placeholders : & [] , regex : "^Invalid token type$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Authentication/Token/PublicKeyTokenProvider.php" , line : 327usize , placeholders : & [] , regex : "^Invalid token type$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Authentication/Token/PublicKeyTokenProvider.php" , line : 352usize , placeholders : & [] , regex : "^Invalid token type$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Authentication/Token/PublicKeyTokenProvider.php" , line : 439usize , placeholders : & [] , regex : "^OpenSSL reported a problem$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Authentication/Token/PublicKeyTokenProvider.php" , line : 444usize , placeholders : & [] , regex : "^OpenSSL reported a problem$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Authentication/Token/PublicKeyTokenProvider.php" , line : 456usize , placeholders : & [] , regex : "^Trying to save a password with more than 469 characters is not supported\\. If you want to use big passwords, disable the auth\\.storeCryptedPassword option in config\\.php$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Authentication/Token/PublicKeyTokenProvider.php" , line : 477usize , placeholders : & [] , regex : "^Invalid token type$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Setup.php" , line : 477usize , placeholders : & [] , regex : "^overwrite\\.cli\\.url is empty$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Setup.php" , line : 480usize , placeholders : & [] , regex : "^invalid value for overwrite\\.cli\\.url$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Share.php" , line : 120usize , placeholders : & [] , regex : "^String expected\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Share.php" , line : 124usize , placeholders : & [] , regex : "^Not allowed to assign a new internal id to a share$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Share.php" , line : 153usize , placeholders : & [] , regex : "^String expected\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Share.php" , line : 157usize , placeholders : & [] , regex : "^Not allowed to assign a new provider id to a share$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 439usize , placeholders : & [] , regex : "^Expiration date is enforced$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 515usize , placeholders : & [] , regex : "^Expiration date is enforced$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 617usize , placeholders : & [] , regex : "^Group sharing is now allowed$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 625usize , placeholders : & [] , regex : "^Sharing is only allowed within your own groups$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 646usize , placeholders : & [] , regex : "^Path is already shared with this group$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 660usize , placeholders : & [] , regex : "^Link sharing is not allowed$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 666usize , placeholders : & [] , regex : "^Public upload is not allowed$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 701usize , placeholders : & [] , regex : "^Path contains files shared with you$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 715usize , placeholders : & [] , regex : "^Sharing is disabled$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 719usize , placeholders : & [] , regex : "^Sharing is disabled for you$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 803usize , placeholders : & [] , regex : "^Cannot share with the share owner$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/Share20/Manager.php" , line : 875usize , placeholders : & [] , regex : "^Share notification not sent because mailsend is false\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/Share20/Manager.php" , line : 963usize , placeholders : & [] , regex : "^Share notification mail could not be sent$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 982usize , placeholders : & [] , regex : "^Share does not have a full id$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 987usize , placeholders : & [] , regex : "^Cannot change share type$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 993usize , placeholders : & [] , regex : "^Can only update recipient on user shares$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 999usize , placeholders : & [] , regex : "^Cannot share with the share owner$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 1034usize , placeholders : & [] , regex : "^Cannot enable sending the password by Talk with an empty password$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 1044usize , placeholders : & [] , regex : "^Cannot enable sending the password by Talk without setting a new password$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 1047usize , placeholders : & [] , regex : "^Cannot disable sending the password by Talk without setting a new password$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 1129usize , placeholders : & [] , regex : "^Share provider does not support accepting$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 1238usize , placeholders : & [] , regex : "^Share does not have a full id$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 1293usize , placeholders : & [] , regex : "^Cannot change target of link share$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 1307usize , placeholders : & [] , regex : "^Invalid recipient$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Share20/Manager.php" , line : 1340usize , placeholders : & [] , regex : "^invalid path$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/Preview/Movie.php" , line : 159usize , placeholders : & [] , regex : "^Movie preview generation failed Output: \\{output\\}$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Preview/Generator.php" , line : 157usize , placeholders : & [] , regex : "^Cached preview size 0, invalid!$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Preview/Generator.php" , line : 168usize , placeholders : & [] , regex : "^Max preview size 0, invalid!$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Preview/Generator.php" , line : 213usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Preview/Generator.php" , line : 218usize , placeholders : & [] , regex : "^Cached preview size 0, invalid!$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Preview/Generator.php" , line : 304usize , placeholders : & [] , regex : "^No provider successfully handled the preview generation$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Preview/Generator.php" , line : 609usize , placeholders : & [] , regex : "^Failed to generate preview, failed to load image$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/User/Session.php" , line : 794usize , placeholders : & [] , regex : "^Session token is invalid because it does not exist$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/lib/private/User/Session.php" , line : 807usize , placeholders : & [] , regex : "^Session token credentials are invalid$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/lib/private/User/Session.php" , line : 830usize , placeholders : & [] , regex : "^App token login name does not match$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/lib/private/User/Session.php" , line : 910usize , placeholders : & [] , regex : "^Tried to log in but could not verify token$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/User/Session.php" , line : 920usize , placeholders : & [] , regex : "^Remember\\-me token replaced$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/User/Session.php" , line : 928usize , placeholders : & [] , regex : "^Session token replaced$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Critical , path : "/lib/private/User/Session.php" , line : 933usize , placeholders : & [] , regex : "^Could not renew session token for \\{uid\\} because the session is unavailable$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/User/Session.php" , line : 985usize , placeholders : & [] , regex : "^Session token invalidated before logout$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/lib/private/User/Session.php" , line : 991usize , placeholders : & [] , regex : "^Logging out$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Comments/Manager.php" , line : 1110usize , placeholders : & [] , regex : "^The database does not support reactions$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Comments/Manager.php" , line : 1373usize , placeholders : & [] , regex : "^Comment to update does ceased to exist$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Comments/Manager.php" , line : 1588usize , placeholders : & [] , regex : "^String expected\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Comments/Manager.php" , line : 1591usize , placeholders : & [] , regex : "^Displayname resolver for this type already registered$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Comments/Manager.php" , line : 1611usize , placeholders : & [] , regex : "^String expected\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Comments/Manager.php" , line : 1614usize , placeholders : & [] , regex : "^No Displayname resolver for this type registered$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/private/Comments/Manager.php" , line : 1633usize , placeholders : & [] , regex : "^The given entity does not implement the ICommentsEntity interface$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/base.php" , line : 280usize , placeholders : & [] , regex : "^Not installed$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/base.php" , line : 614usize , placeholders : & [] , regex : "^Composer autoloader not found, unable to continue\\. Check the folder \"3rdparty\"\\. Running \"git submodule update \\-\\-init\" will initialize the git submodule that handles the subfolder \"3rdparty\"\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Unknown , path : "/lib/base.php" , line : 632usize , placeholders : & [] , regex : "^autoloader$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/lib/base.php" , line : 645usize , placeholders : & [] , regex : "^Could not set timezone to UTC$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/lib/base.php" , line : 828usize , placeholders : & [] , regex : "^Trusted domain error\\. \"\\{remoteAddress\\}\" tried to access using \"\\{host\\}\" as host\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Unknown , path : "/lib/base.php" , line : 845usize , placeholders : & [] , regex : "^init$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/lib/base.php" , line : 881usize , placeholders : & [] , regex : "^Exception when running cache gc\\.$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/encryption/lib/Crypto/Crypt.php" , line : 197usize , placeholders : & [] , regex : "^Encryption Library, symmetrical encryption failed no content given$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/encryption/lib/Crypto/Crypt.php" , line : 335usize , placeholders : & [] , regex : "^Legacy cipher is no longer supported!$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/encryption/lib/Crypto/Crypt.php" , line : 532usize , placeholders : & [] , regex : "^Bad Signature$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/apps/encryption/lib/Crypto/Crypt.php" , line : 534usize , placeholders : & [] , regex : "^Signature check skipped$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/encryption/lib/Crypto/Crypt.php" , line : 614usize , placeholders : & [] , regex : "^Missing Signature$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/encryption/lib/Crypto/Crypt.php" , line : 619usize , placeholders : & [] , regex : "^Missing Signature$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/encryption/lib/Crypto/Crypt.php" , line : 706usize , placeholders : & [] , regex : "^Cannot multikey decrypt empty plain content$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/related_resources/lib/RelatedResourceProviders/FilesRelatedResourceProvider.php" , line : 271usize , placeholders : & [] , regex : "^Circles needs to be enabled$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/related_resources/lib/RelatedResourceProviders/TalkRelatedResourceProvider.php" , line : 230usize , placeholders : & [] , regex : "^Circles needs to be enabled$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/related_resources/lib/RelatedResourceProviders/DeckRelatedResourceProvider.php" , line : 206usize , placeholders : & [] , regex : "^Circles needs to be enabled$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/related_resources/lib/Service/RelatedService.php" , line : 585usize , placeholders : & [] , regex : "^flush cache$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/files_sharing/lib/DeleteOrphanedSharesJob.php" , line : 59usize , placeholders : & ["$deletedEntries"] , regex : "^(.*) orphaned share\\(s\\) deleted$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/Controller/ShareAPIController.php" , line : 1104usize , placeholders : & [] , regex : "^no sharing rights on this item$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/Controller/ShareAPIController.php" , line : 1214usize , placeholders : & [] , regex : "^You are not allowed to edit incoming shares$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/Controller/ShareAPIController.php" , line : 1254usize , placeholders : & [] , regex : "^You are not allowed to edit link shares that you don't own$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/Controller/ShareAPIController.php" , line : 1326usize , placeholders : & [] , regex : "^Maximum label length is 255$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/Controller/ShareAPIController.php" , line : 1669usize , placeholders : & [] , regex : "^Invalid date\\. Format must be YYYY\\-MM\\-DD$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/Controller/ShareAPIController.php" , line : 1877usize , placeholders : & [] , regex : "^no sharing rights on this item$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/Controller/ShareAPIController.php" , line : 2070usize , placeholders : & [] , regex : "^Should not happen, instanceOfStorage but getInstanceOfStorage return null$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/Controller/ShareAPIController.php" , line : 2073usize , placeholders : & [] , regex : "^Should not happen, instanceOfStorage but not a wrapper$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/Controller/ShareesAPIController.php" , line : 157usize , placeholders : & [] , regex : "^Invalid perPage argument$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/Controller/ShareesAPIController.php" , line : 160usize , placeholders : & [] , regex : "^Invalid page$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/Controller/ShareesAPIController.php" , line : 168usize , placeholders : & [] , regex : "^Missing itemType$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/Controller/ShareesAPIController.php" , line : 346usize , placeholders : & [] , regex : "^Missing itemType$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Notice , path : "/apps/files_sharing/lib/External/Storage.php" , line : 89usize , placeholders : & [] , regex : "^exception while retrieving webdav endpoint$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/External/Storage.php" , line : 242usize , placeholders : & [] , regex : "^Remote share not found$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/External/Storage.php" , line : 245usize , placeholders : & [] , regex : "^No nextcloud instance found at remote$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/External/Storage.php" , line : 251usize , placeholders : & [] , regex : "^Auth error when getting remote share$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/External/Storage.php" , line : 253usize , placeholders : & [] , regex : "^Failed to connect to remote instance$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_sharing/lib/External/Storage.php" , line : 255usize , placeholders : & [] , regex : "^Error while sending request to remote instance$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/apps/dav/lib/BackgroundJob/PruneOutdatedSyncTokensJob.php" , line : 59usize , placeholders : & [] , regex : "^Pruned \\{calendarSyncTokensNumber\\} calendar sync tokens and \\{addressBooksSyncTokensNumber\\} address book sync tokens$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/dav/lib/CalDAV/Schedule/IMipPlugin.php" , line : 190usize , placeholders : & [] , regex : "^iTip message said the change was significant but comparison did not detect any updated VEvents$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/dav/lib/CalDAV/Schedule/IMipPlugin.php" , line : 312usize , placeholders : & [] , regex : "^Unable to deliver message to \\{failed\\}$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/CalDAV/CalDavBackend.php" , line : 785usize , placeholders : & [] , regex : "^URI too long\\. Calendar not created$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/CalDAV/CalDavBackend.php" , line : 966usize , placeholders : & [] , regex : "^Calendar data that was just written can't be read back\\. Check your database configuration\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/CalDAV/CalDavBackend.php" , line : 1256usize , placeholders : & [] , regex : "^Calendar object with uid already exists in this calendar collection\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/CalDAV/CalDavBackend.php" , line : 1499usize , placeholders : & ["$newUri" , "$calendarId"] , regex : "^A calendar object with URI (.*) already exists in calendar (.*), therefore this object can't be moved into the trashbin$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/CalDAV/CalDavBackend.php" , line : 1543usize , placeholders : & ["$id" , "$restoreUri"] , regex : "^Can not restore calendar (.*) because a calendar object with the URI (.*) already exists$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/CalDAV/CalDavBackend.php" , line : 1570usize , placeholders : & [] , regex : "^Calendar object data that was just written can't be read back\\. Check your database configuration\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/CalDAV/CalDavBackend.php" , line : 2469usize , placeholders : & [] , regex : "^The \\{http://calendarserver\\.org/ns/\\}source property is required when creating subscriptions$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/CalDAV/CalDavBackend.php" , line : 2785usize , placeholders : & [] , regex : "^Calendar objects must have a VJOURNAL, VEVENT or VTODO component$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/CardDAV/CardDavBackend.php" , line : 383usize , placeholders : & [] , regex : "^URI too long\\. Address book not created$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/CardDAV/CardDavBackend.php" , line : 646usize , placeholders : & [] , regex : "^VCard object with uid already exists in this addressbook collection\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/CardDAV/CardDavBackend.php" , line : 1385usize , placeholders : & [] , regex : "^vCards on CardDAV servers MUST have a UID property$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/CardDAV/CardDavBackend.php" , line : 1388usize , placeholders : & [] , regex : "^vCard can not be empty$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/dav/lib/CardDAV/SyncService.php" , line : 79usize , placeholders : & [] , regex : "^Client exception:$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/dav/lib/Connector/Sabre/FilesPlugin.php" , line : 436usize , placeholders : & [] , regex : "^Inefficient fetching of metadata$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/dav/lib/Connector/Sabre/Directory.php" , line : 331usize , placeholders : & [] , regex : "^error while getting quota as the relative path cannot be found$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/dav/lib/Connector/Sabre/Directory.php" , line : 348usize , placeholders : & [] , regex : "^error while getting quota into$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/dav/lib/Connector/Sabre/Directory.php" , line : 351usize , placeholders : & [] , regex : "^error while getting quota into$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/dav/lib/Connector/Sabre/Directory.php" , line : 354usize , placeholders : & [] , regex : "^error while getting quota into$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/Connector/Sabre/Directory.php" , line : 391usize , placeholders : & [] , regex : "^Incompatible node types$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/Connector/Sabre/Directory.php" , line : 395usize , placeholders : & [] , regex : "^filesystem not setup$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/Connector/Sabre/Directory.php" , line : 452usize , placeholders : & [] , regex : "^$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/SystemTag/SystemTagsObjectMappingCollection.php" , line : 75usize , placeholders : & [] , regex : "^Permission denied to create collections$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/SystemTag/SystemTagsObjectMappingCollection.php" , line : 89usize , placeholders : & [] , regex : "^Invalid tag id$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/SystemTag/SystemTagsObjectMappingCollection.php" , line : 126usize , placeholders : & [] , regex : "^Invalid tag id$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/SystemTag/SystemTagsObjectMappingCollection.php" , line : 133usize , placeholders : & [] , regex : "^Permission denied to delete this collection$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/SystemTag/SystemTagsObjectMappingCollection.php" , line : 141usize , placeholders : & [] , regex : "^Permission denied to rename this collection$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/SystemTag/SystemTagsObjectTypeCollection.php" , line : 59usize , placeholders : & [] , regex : "^Permission denied to create nodes$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/SystemTag/SystemTagsObjectTypeCollection.php" , line : 67usize , placeholders : & [] , regex : "^Permission denied to create collections$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/SystemTag/SystemTagsObjectTypeCollection.php" , line : 79usize , placeholders : & [] , regex : "^Entity does not exist or is not available$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/SystemTag/SystemTagsObjectTypeCollection.php" , line : 107usize , placeholders : & [] , regex : "^Permission denied to delete this collection$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/dav/lib/SystemTag/SystemTagsObjectTypeCollection.php" , line : 119usize , placeholders : & [] , regex : "^Permission denied to rename this collection$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/serverinfo/lib/OperatingSystems/DefaultOs.php" , line : 275usize , placeholders : & [] , regex : "^Unable to get network interfaces$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/AUserData.php" , line : 230usize , placeholders : & [] , regex : "^User does not exist$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/AUserData.php" , line : 264usize , placeholders : & [] , regex : "^User does not exist$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/provisioning_api/lib/Controller/AUserData.php" , line : 275usize , placeholders : & [] , regex : "^Could not load storage info for \\{user\\}$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 314usize , placeholders : & [] , regex : "^Could not create non\\-existing user id$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 351usize , placeholders : & [] , regex : "^Failed addUser attempt: User already exists\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 366usize , placeholders : & [] , regex : "^no group specified \\(required for subadmins\\)$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 376usize , placeholders : & [] , regex : "^Subadmin group does not exist$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 380usize , placeholders : & [] , regex : "^Cannot create subadmins for admin group$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 384usize , placeholders : & [] , regex : "^No permissions to promote subadmins$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 392usize , placeholders : & [] , regex : "^Invalid password value$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 396usize , placeholders : & [] , regex : "^To send a password link to the user an email address is required\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 415usize , placeholders : & [] , regex : "^Required email address was not provided$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 459usize , placeholders : & ["$email"] , regex : "^Unable to send the invitation mail to (.*)$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 472usize , placeholders : & [] , regex : "^Failed addUser attempt with hint exception\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 481usize , placeholders : & [] , regex : "^Failed addUser attempt with ocs exception\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 490usize , placeholders : & [] , regex : "^Failed addUser attempt with invalid argument exception\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 499usize , placeholders : & [] , regex : "^Failed addUser attempt with exception\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 506usize , placeholders : & [] , regex : "^Bad request$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 530usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 555usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 568usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 585usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 593usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 601usize , placeholders : & [] , regex : "^$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 849usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 886usize , placeholders : & [] , regex : "^Unlimited quota is forbidden on this instance$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 894usize , placeholders : & [] , regex : "^Invalid password value$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 897usize , placeholders : & [] , regex : "^Setting the password is not supported by the users backend$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 907usize , placeholders : & [] , regex : "^Invalid language$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 913usize , placeholders : & [] , regex : "^Invalid locale$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 924usize , placeholders : & [] , regex : "^Cannot set primary email, because provided address is not verified$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 934usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 941usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 956usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1028usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1050usize , placeholders : & [] , regex : "^$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1060usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1082usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1086usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1092usize , placeholders : & [] , regex : "^$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1140usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1146usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1167usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1193usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1209usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1215usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1218usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1225usize , placeholders : & [] , regex : "^$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1256usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1262usize , placeholders : & [] , regex : "^$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1269usize , placeholders : & [] , regex : "^Cannot remove yourself from the admin group$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1273usize , placeholders : & [] , regex : "^Cannot remove yourself from this group as you are a SubAdmin$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1286usize , placeholders : & [] , regex : "^Not viable to remove user from the last group you are SubAdmin of$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1311usize , placeholders : & [] , regex : "^User does not exist$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1315usize , placeholders : & [] , regex : "^Group does not exist$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1319usize , placeholders : & [] , regex : "^Cannot create subadmins for admin group$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1350usize , placeholders : & [] , regex : "^User does not exist$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1354usize , placeholders : & [] , regex : "^Group does not exist$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1358usize , placeholders : & [] , regex : "^User is not a subadmin of this group$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1408usize , placeholders : & [] , regex : "^Email address not available$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1415usize , placeholders : & ["$email"] , regex : "^Can't send new user mail to (.*)$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/provisioning_api/lib/Controller/UsersController.php" , line : 1422usize , placeholders : & [] , regex : "^Sending email failed$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_external/lib/Lib/Storage/SMB.php" , line : 524usize , placeholders : & [] , regex : "^not enough available space to create file$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_external/lib/Lib/Storage/SMB.php" , line : 567usize , placeholders : & [] , regex : "^not enough available space to create file$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Access.php" , line : 344usize , placeholders : & [] , regex : "^LDAP password changes are disabled\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Access.php" , line : 349usize , placeholders : & [] , regex : "^LDAP resource not available\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Access.php" , line : 357usize , placeholders : & [] , regex : "^Password change rejected\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Access.php" , line : 908usize , placeholders : & ["$ocName"] , regex : "^The ldap user manager returned null for (.*)$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Access.php" , line : 1048usize , placeholders : & [] , regex : "^Invoker does not support controlPagedResultResponse, call LDAP Wrapper directly instead\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Access.php" , line : 1064usize , placeholders : & ["$command"] , regex : "^Connection lost on (.*), attempting to reestablish\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Access.php" , line : 1070usize , placeholders : & ["$command"] , regex : "^Could not (.*), because resource is missing\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Access.php" , line : 1104usize , placeholders : & [] , regex : "^Could not search, because resource is missing\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Access.php" , line : 1164usize , placeholders : & [] , regex : "^Paged search was not available$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Access.php" , line : 1200usize , placeholders : & [] , regex : "^Count filter: \\{filter\\}$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Access.php" , line : 1383usize , placeholders : & [] , regex : "^provided name template for username does not contain any allowed characters$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Access.php" , line : 1395usize , placeholders : & [] , regex : "^provided name template for username does not contain any allowed characters$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Access.php" , line : 1493usize , placeholders : & [] , regex : "^searchAttributes must be an array with at least two string$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Access.php" , line : 1619usize , placeholders : & [] , regex : "^Cannot determine UUID attribute$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Access.php" , line : 1626usize , placeholders : & [] , regex : "^Cannot determine UUID attribute$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Access.php" , line : 1643usize , placeholders : & [] , regex : "^Cannot determine UUID attribute$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Access.php" , line : 1691usize , placeholders : & [] , regex : "^Setting \\{attribute\\} as \\{subject\\}$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Access.php" , line : 1704usize , placeholders : & [] , regex : "^Could not autodetect the UUID attribute$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Access.php" , line : 1961usize , placeholders : & [] , regex : "^initializing paged search for filter \\{filter\\}, base \\{base\\}, attr \\{attr\\}, pageSize \\{pageSize\\}, offset \\{offset\\}$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Access.php" , line : 1989usize , placeholders : & [] , regex : "^Ready for a paged search$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Connection.php" , line : 247usize , placeholders : & [] , regex : "^Connection to LDAP server could not be established$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/apps/user_ldap/lib/Connection.php" , line : 446usize , placeholders : & [] , regex : "^LDAPS \\(already using secure connection\\) and TLS do not work together\\. Switched off TLS\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/user_ldap/lib/Connection.php" , line : 576usize , placeholders : & [] , regex : "^Configuration is invalid, cannot connect$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/user_ldap/lib/Connection.php" , line : 585usize , placeholders : & [] , regex : "^function ldap_connect is not available\\. Make sure that the PHP ldap module is installed\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Connection.php" , line : 594usize , placeholders : & [] , regex : "^Turned off SSL certificate validation successfully\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/user_ldap/lib/Connection.php" , line : 599usize , placeholders : & [] , regex : "^Could not turn off SSL certificate validation\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/user_ldap/lib/Connection.php" , line : 627usize , placeholders : & [] , regex : "^Main LDAP not reachable, connecting to backup$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Connection.php" , line : 666usize , placeholders : & [] , regex : "^Could not set required LDAP Protocol version\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Connection.php" , line : 670usize , placeholders : & [] , regex : "^Could not disable LDAP referrals\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Connection.php" , line : 674usize , placeholders : & [] , regex : "^Could not set network timeout$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Configuration.php" , line : 549usize , placeholders : & [] , regex : "^Invalid rule$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/user_ldap/lib/Configuration.php" , line : 567usize , placeholders : & [] , regex : "^Invalid config value to ldapUserAvatarRule; falling back to default\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Group_LDAP.php" , line : 242usize , placeholders : & [] , regex : "^No search filter found on member url of group \\{dn\\}$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Group_LDAP.php" , line : 470usize , placeholders : & [] , regex : "^Not a valid group$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Group_LDAP.php" , line : 594usize , placeholders : & [] , regex : "^Not a valid group$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Group_LDAP.php" , line : 757usize , placeholders : & [] , regex : "^No search filter found on member url of group \\{dn\\}$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/user_ldap/lib/Group_LDAP.php" , line : 795usize , placeholders : & [] , regex : "^No uid attribute found for DN \\{dn\\} on \\{host\\}$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Group_LDAP.php" , line : 1263usize , placeholders : & [] , regex : "^Could not create group in LDAP backend\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Group_LDAP.php" , line : 1314usize , placeholders : & [] , regex : "^Could not add user to group in LDAP backend\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Group_LDAP.php" , line : 1333usize , placeholders : & [] , regex : "^Could not remove user from group in LDAP backend\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/user_ldap/lib/Group_LDAP.php" , line : 1347usize , placeholders : & [] , regex : "^Could not get group details in LDAP backend\\.$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/oauth2/lib/Db/AccessTokenMapper.php" , line : 66usize , placeholders : & [] , regex : "^Could not find access token$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/oauth2/lib/Controller/OauthApiController.php" , line : 180usize , placeholders : & [] , regex : "^OAuth client secret decryption error$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_versions/lib/Versions/LegacyVersionsBackend.php" , line : 224usize , placeholders : & [] , regex : "^You cannot label this version because you do not have update permissions on the source file\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_versions/lib/Versions/LegacyVersionsBackend.php" , line : 240usize , placeholders : & [] , regex : "^You cannot delete this version because you do not have delete permissions on the source file\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_versions/lib/Versions/LegacyVersionsBackend.php" , line : 256usize , placeholders : & [] , regex : "^No user logged in$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/files_versions/lib/Versions/LegacyVersionsBackend.php" , line : 263usize , placeholders : & [] , regex : "^Version file not accessible by current user$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/settings/lib/Controller/CheckSetupController.php" , line : 322usize , placeholders : & [] , regex : "^error checking curl$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/contactsinteraction/lib/Listeners/ContactInteractionListener.php" , line : 71usize , placeholders : & [] , regex : "^Contact interaction event has no user identifier set$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/apps/contactsinteraction/lib/Listeners/ContactInteractionListener.php" , line : 76usize , placeholders : & [] , regex : "^Ignoring contact interaction with self$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/workflowengine/lib/Controller/UserWorkflowsController.php" , line : 118usize , placeholders : & [] , regex : "^User not logged in$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/workflowengine/lib/Controller/AWorkflowController.php" , line : 125usize , placeholders : & [] , regex : "^Error when inserting flow$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/workflowengine/lib/Controller/AWorkflowController.php" , line : 126usize , placeholders : & [] , regex : "^An internal error occurred$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/workflowengine/lib/Controller/AWorkflowController.php" , line : 155usize , placeholders : & [] , regex : "^An internal error occurred$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/workflowengine/lib/Controller/AWorkflowController.php" , line : 175usize , placeholders : & [] , regex : "^An internal error occurred$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/notifications/lib/Push.php" , line : 502usize , placeholders : & [] , regex : "^Could not send notification to push server \\[\\{url\\}\\]: \\{error\\}$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/notifications/lib/Push.php" , line : 537usize , placeholders : & [] , regex : "^Could not send notification to push server \\[\\{url\\}\\]: \\{error\\}$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/apps/notifications/lib/Push.php" , line : 545usize , placeholders : & [] , regex : "^Push notification sent but response was not parsable, using an outdated push proxy\\? \\[\\{url\\}\\]: \\{error\\}$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/notifications/lib/Push.php" , line : 625usize , placeholders : & [] , regex : "^Failed to encrypt message for device$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/notifications/lib/Push.php" , line : 676usize , placeholders : & [] , regex : "^Failed to encrypt message for device$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/notifications/lib/Notifier/AdminNotifications.php" , line : 91usize , placeholders : & [] , regex : "^Unknown app$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/notifications/lib/Notifier/AdminNotifications.php" , line : 220usize , placeholders : & [] , regex : "^Unknown subject$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/apps/theming/lib/Migration/MigrateAdminConfig.php" , line : 54usize , placeholders : & [] , regex : "^Migrating administration images$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/apps/theming/lib/Migration/MigrateAdminConfig.php" , line : 62usize , placeholders : & [] , regex : "^Migrating administration images$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Info , path : "/apps/theming/lib/Migration/MigrateAdminConfig.php" , line : 87usize , placeholders : & [] , regex : "^No administration images to migrate$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/circles/lib/Service/MaintenanceService.php" , line : 215usize , placeholders : & [] , regex : "^maintenance already running$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/circles/lib/ShareByCircleProvider.php" , line : 304usize , placeholders : & [] , regex : "^Shares::move\\(\\)$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/circles/lib/ShareByCircleProvider.php" , line : 333usize , placeholders : & [] , regex : "^Shares::move\\(\\)$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/circles/lib/ShareByCircleProvider.php" , line : 357usize , placeholders : & [] , regex : "^Shares::restore\\(\\)$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/circles/lib/ShareByCircleProvider.php" , line : 407usize , placeholders : & [] , regex : "^shared document is not available anymore$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Notice , path : "/apps/circles/lib/ShareByCircleProvider.php" , line : 409usize , placeholders : & [] , regex : "^share is not available while path is empty\\. might comes from an unsupported storage\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/circles/lib/ShareByCircleProvider.php" , line : 614usize , placeholders : & [] , regex : "^Circle not found while probeCircle$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/federation/lib/SyncFederationAddressBooks.php" , line : 88usize , placeholders : & ["$url"] , regex : "^Server sync for (.*) failed\\.$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/text/lib/Service/ApiService.php" , line : 95usize , placeholders : & [] , regex : "^No permission to access this file$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/text/lib/Service/AttachmentService.php" , line : 320usize , placeholders : & [] , regex : "^No write permissions$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/text/lib/Service/AttachmentService.php" , line : 348usize , placeholders : & [] , regex : "^No write permissions$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/text/lib/Service/AttachmentService.php" , line : 377usize , placeholders : & [] , regex : "^No write permissions$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/text/lib/Service/SessionService.php" , line : 225usize , placeholders : & [] , regex : "^Logged in users cannot set a guest name$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/text/lib/Service/DocumentService.php" , line : 138usize , placeholders : & [] , regex : "^Unsaved steps, continue collaborative editing$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/text/lib/Service/DocumentService.php" , line : 148usize , placeholders : & [] , regex : "^No app data folder present for text documents$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/text/lib/Service/DocumentService.php" , line : 179usize , placeholders : & [] , regex : "^No app data folder present for text documents$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/text/lib/Service/DocumentService.php" , line : 204usize , placeholders : & [] , regex : "^Failed to create document state file$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/text/lib/Service/DocumentService.php" , line : 274usize , placeholders : & [] , regex : "^Failed to encode steps$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/text/lib/Service/DocumentService.php" , line : 292usize , placeholders : & [] , regex : "^This should never happen\\. An error occurred when storing the version, trying to recover the last stable one$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/text/lib/Service/DocumentService.php" , line : 332usize , placeholders : & [] , regex : "^File changed in the meantime from outside$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Warn , path : "/apps/text/lib/Service/DocumentService.php" , line : 354usize , placeholders : & [] , regex : "^Saving empty document$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/text/lib/Service/DocumentService.php" , line : 416usize , placeholders : & [] , regex : "^Did not reset document, as it has unsaved changes$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/text/lib/Service/DocumentService.php" , line : 461usize , placeholders : & [] , regex : "^No proper share data$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/text/lib/Service/DocumentService.php" , line : 476usize , placeholders : & [] , regex : "^Could not fallback to file from mounts$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/text/lib/Service/DocumentService.php" , line : 530usize , placeholders : & [] , regex : "^No proper share data$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/text/lib/Controller/AttachmentController.php" , line : 115usize , placeholders : & [] , regex : "^File insertion error$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/text/lib/Controller/AttachmentController.php" , line : 132usize , placeholders : & [] , regex : "^Invalid session found when uploading$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/apps/text/lib/Controller/AttachmentController.php" , line : 145usize , placeholders : & [] , regex : "^Could not read file$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/text/lib/Controller/AttachmentController.php" , line : 162usize , placeholders : & [] , regex : "^Upload error$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/text/lib/Controller/AttachmentController.php" , line : 228usize , placeholders : & [] , regex : "^getImageFile error$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/text/lib/Controller/AttachmentController.php" , line : 266usize , placeholders : & [] , regex : "^getMediaFile error$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/text/lib/Controller/AttachmentController.php" , line : 309usize , placeholders : & [] , regex : "^getMediaFilePreview error$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Error , path : "/apps/text/lib/Controller/AttachmentController.php" , line : 345usize , placeholders : & [] , regex : "^getMediaFileMetadata error$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Debug , path : "/apps/text/lib/Cron/Cleanup.php" , line : 75usize , placeholders : & [] , regex : "^Run cleanup job for text sessions$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/core/Controller/ClientFlowLoginController.php" , line : 351usize , placeholders : & [] , regex : "^login name does not match$" , }
,
...
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/core/Command/Maintenance/Install.php" , line : 126usize , placeholders : & ["$db"] , regex : "^Database <(.*)> is not supported\\.$" , }
,
	crate :: LoggingStatement { level : crate :: LogLevel :: Exception , path : "/core/Command/Maintenance/Install.php" , line : 153usize , placeholders : & [] , regex : "^Database user not provided\\.$" , }
,
